...
trait MessageManager {
  ...
  protected def registerFactoryToClient[
    ...
    val messageType: MessageType.Vanilla =
      network.registerMessageToClient(factory.name, factory.receive)
  ...
  protected def registerFactoryToServer[
    ...
    val messageType: MessageType.Vanilla =
      network.registerMessageToServer(factory.name, factory.receive)
