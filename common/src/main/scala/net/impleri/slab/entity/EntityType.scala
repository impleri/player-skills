...
case class EntityType[T <: McEntityType[_]](override val underlying: T) extends ResourceWrapper[T] {
  override val name: Option[ResourceLocation] = Registry.Entities.getKey(underlying.asInstanceOf)
}
