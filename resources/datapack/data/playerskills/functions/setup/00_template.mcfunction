...
execute at @e[tag=setup,limit=1] run setblock ~ ~-2 ~-2 minecraft:chain_command_block[facing=down]{ auto: 0b, Command: "/execute as @e[tag=test_ID,limit=1] at @s run function playerskills:action/start" }
execute at @e[tag=setup,limit=1] run setblock ~ ~-3 ~-2 minecraft:chain_command_block[facing=down]{ auto: 0b, Command: "/execute as @e[tag=test_ID,limit=1] at @s run function playerskills:test/ID" }
...
execute at @e[tag=setup,limit=1] run setblock ~2 ~-1 ~ minecraft:command_block[facing=down]{ auto: 0b, Command: "/execute as @e[tag=test_ID,limit=1] at @s run function playerskills:action/fail" }
...
# This sign explains the test
execute at @e[tag=setup,limit=1] run setblock ~-1 ~ ~-1 oak_sign[rotation=10]{ Text1: '{"text":"Test Name","bold":true}', Text3: '{"text": "Player should ...?"}' } replace

# Wire in environmental setup here
