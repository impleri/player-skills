# Skill cannot be given a value not in its allowed options
...
execute at @e[tag=setup,limit=1] run setblock ~ ~-3 ~-2 minecraft:chain_command_block[conditional=true,facing=down]{ auto: 1b, Command: "/execute at @e[tag=test_06,limit=1] run function playerskills:test/06" }
...
execute at @e[tag=setup,limit=1] run setblock ~ ~-2 ~2 minecraft:chain_command_block[conditional=true,facing=down]{ auto: 1b, Command: "/execute at @e[tag=test_06,limit=1] run function playerskills:reset/06" }
execute at @e[tag=setup,limit=1] run setblock ~ ~ ~2 minecraft:stone_button[face=floor]
...
execute at @e[tag=test_06,limit=1] run function playerskills:reset/06
