...
execute at @e[tag=setup,limit=1] run setblock ~ ~-2 ~-2 minecraft:chain_command_block[facing=down]{ auto: 0b, Command: "/execute as @e[tag=test_09,limit=1] at @s run setblock ~ ~-2 ~ minecraft:redstone_block replace" }
